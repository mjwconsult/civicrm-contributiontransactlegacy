 ...
 */
function contributiontransactlegacy_civicrm_caseTypes(&$caseTypes) {
  _contributiontransactlegacy_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function contributiontransactlegacy_civicrm_themes(&$themes) {
  _contributiontransactlegacy_civix_civicrm_themes($themes);
}
 ...
 *
function contributiontransactlegacy_civicrm_preProcess($formName, &$form) {
 ...
 *
function contributiontransactlegacy_civicrm_navigationMenu(&$menu) {
  _contributiontransactlegacy_civix_insert_navigation_menu($menu, 'Mailings', array(
  ...
  _contributiontransactlegacy_civix_navigationMenu($menu);
} // */
